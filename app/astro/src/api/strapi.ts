...
interface Props {
  ...
  function ParseImage(data: any) {
    data.data.map((res: any) => {
      if(res.attributes.cover) {
        res.attributes.cover = {
          id: res.attributes.cover.data.id,
          name: res.attributes.cover.data.attributes.name,
          ext: res.attributes.cover.data.attributes.ext,
          originalurl: import.meta.env.STRAPI_URL + res.attributes.cover.data.attributes.url,
          smallurl: import.meta.env.STRAPI_URL + res.attributes.cover.data.attributes.formats.small.url,
          mediumurl: import.meta.env.STRAPI_URL + res.attributes.cover.data.attributes.formats.medium.url,
          largeurl: import.meta.env.STRAPI_URL + res.attributes.cover.data.attributes.formats.large.url,
        }
      }
      return res;
    })
